...
// console.log(json.quotes.map(quote => `${quote.id} - ${quote.author}`).join('\n'));
...
// let respose = fatch("https://dummyjson.com/quotes")

// console.log(respose);   pindeing


async function getRandomQuote() {
    let res = await fetch("https://dummyjson.com/quotes");
    let data = await res.json(); // response ko JSON mein convert karo
    console.log(data); // ab actual data show hoga
}
